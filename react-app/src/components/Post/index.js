                        ...
                        <NavLink className="single-post" exact to={`/post/${ele.id}`}>
                                ...
                                <div className="display-info-container">
                                    <div className="story-title-and-description">
                                        ...
                                        <p className="test">test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test...
                                        </p>
                                    </div>
                                    <div>
